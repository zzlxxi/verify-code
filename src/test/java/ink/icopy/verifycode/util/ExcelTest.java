...
public class ExcelTest {
  ...
  private static final String FOLDER_NAME = "D:" + File.separator + "excel-test/";
  ...
  public void ReadWorkBookByInputStreamLoopCell() throws IOException {
    ...
    for (Row row : sheet1) {
      for (Cell cell : row) {
        ...
        // get the text that appears in the cell by getting the cell value and applying any data
        // formats (Date, 0.00, 1.23e9, $1.23, etc)
